...
var updateStaffs = function(data){
  ...
  ReactDOM.render(
    React.createElement(Staff, {staffid: data.no, place: "", time: data.lastdatetime}),
...
$( document ).ready(function() {
  ...
  $.each(staffs, function(idx, data){
    ...
    ReactDOM.render(
      React.createElement(Staff, {staffid: data, place: "A01", lastdatetime: "2016-04-11 08:24:28"}),
  ...
  $.each(items, function(idx, data){
    ...
    ReactDOM.render(
      React.createElement(Item, {itemid: data, place: "A01", lastdatetime: "2016-04-11 08:24:28"}),
